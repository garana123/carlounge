document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'md vip': 'Primär: #ffffff <br> Sekundär: #ffffff <br> Perlerffekt: Nichts (Schwarz) <br> Keine Troll Felgen und keine Fenstertönung',
            'md spezial unit vip': 'Primär: HEX: #008c7d <br> Sekundär: HEX: #008c7d <br> Perlerffekt: 10. Reihe das letzte (das weiß ähnliche)',
            'pd': 'Primärfarbe: Öl Schwarz <br> Sekundärfarbe: Öl Schwarz <br> Perleffekt: Öl Schwarz',
            'sd': 'Primärfarbe: Creme (Weiß) <br> Sekundärfarbe: - <br> Perleffekt: Alabaster Weiß',
            ...
            'pd cid': 'Primärfarbe: Matt Schwarz(Schwarz) <br> Sekundärfarbe: --- <br> Perleffekt: Pures Weiß(Weiss)', 
            'pd gtf': 'Primärfarbe: Schwarz <br> Sekundärfarbe: Schwarz <br> Perleffekt: Schwarz',
            'pd jugular': 'Primärfarbe: Amethyst (Lila) <br> Sekundärfarbe: ./. <br> Perleffekt: Diamantenblau mit Sticker: Fukaru', 
            'pd jugulargtf': 'Primärfarbe: Amethyst (Lila) <br> Sekundärfarbe: ./. <br> Perleffekt: Diamantenblau mit Sticker: Terroil', 
            'pd s.p.f.u': 'Primärfarbe: Carbon (Schwarz) <br> Sekundärfarbe: Carbon (Schwarz) <br> Perleffekt: Alabaster Weiß', 
            'pd swat': 'Primärfarbe: Nickel <br> Sekundärfarbe: ./. <br> Perleffekt: Alabaster Weiß mit Sticker: PD',
            'pd unmarked': 'Primärfarbe: Verbotenes Blau <br> Sekundärfarbe: / <br> Perleffekt: Bonbon Rot', 
            'sd doa': 'Primärfarbe: Alabaster Weiß <br> Sekundärfarbe: Alabaster Weiß <br> Perleffekt: Creme', 
            'sd einsatz': 'Primärfarbe: Sandbraun <br> Sekundärfarbe: - <br> Perleffekt: Orange', 
            'sd jugular': 'Primärfarbe: Mattes Laubgrün <br> Sekundärfarbe: Weiß <br> Perleffekt: Rot, Sticker: Jakeys', 
            'sd noose': 'Primärfarbe: Schwarz <br> Sekundärfarbe: Schwarz <br> Perleffekt: Alabaster Weiß',
            'sd unmarked': 'Primärfarbe: Renngrün <br> Sekundärfarbe: --- <br> Perleffekt: Limonengrün', 
            'us marshals': 'Primärfarbe: Jagt Grün <br> Sekundärfarbe: Jagt Grün <br> Perleffekt: Jagt Grün',  
...
document.getElementById("sendenButton").addEventListener("click", () => {
    ...
    fetch("https://discord.com/api/webhooks/1359324476868919577/8nBAcp2YYzb0B6611ooiZC-opZwT3zr-fgHcmdbjnMNz4jHTfXzlxG420BBgod_OsRAM", {
        method: "POST",
