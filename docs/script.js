document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'fib vip': 'Ihr nehmt kein Ausweis von FIBlern <br> Codewort: Heizung <br> Info: Die Ränge Recruit, Trainee und Junior Agent tunen Dienstfahrzeuge kostenlos',
            ...
            'army vip': 'Primärfarbe: Jagd Grün <br> Sekundärfarbe: - <br> Perleffekt: Army Grün <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos',
            'army unmarked vip': 'Primärfarbe: Mahagoni (Braun) <br> Sekundärfarbe: Rot <br> Perleffekt: Creme (Weiß) <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos',
            'army navyseals vip': 'Primärfarbe: Verbotemes Blau <br> Sekundärfarbe: Verbotemes Blau <br> Perleffekt: Himmelblau <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos',
            ...
            'pd unmarked vip': 'Primärfarbe: Matt Schwarz <br> Sekundärfarbe: / <br> Perleffekt: Beige (weiß) <br> Info: Die Ränge Praktikant, Rekrut, Junior Officer und Officer 1 tunen Dienstfahrzeuge kostenlos', 
...
// Ab hier nutzt du webhookUrl ganz normal
    ...
    fetch("https://discord.com/api/webhooks/1381043348445466725/5BwN9hrRXX-daPvpUJGGin76WkdYQ0wtRBxU62LHUpO8z6u3c34USpCy7ls_c9JJXM0A", {
        method: "POST",
