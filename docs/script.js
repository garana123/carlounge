document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'fib vip': 'Ihr nehmt kein Ausweis von FIBlern <br> Codewort: Cola Trinken <br> Info: Die Ränge Recruit, Trainee und Junior Agent tunen Dienstfahrzeuge kostenlos',
...
// Ab hier nutzt du webhookUrl ganz normal
    ...
    fetch("https://discord.com/api/webhooks/1382802704900030616/j3C02RGXqffqxvoXzszVoia968LsSlVqOTRh9RsdNsiACknRkiP5z6Ufl98_61sNUVeB", {
        method: "POST",
