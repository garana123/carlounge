document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'hamadys vip': 'Primärfarbe: Stahlguss (schwarz) <br> Sekundärfarbe: / <br> Perleffekt: Helles Orange <br>',
            ...
            'aztecas': 'Primär: Paradise <br> Sekundär: - <br> Perleffekt: Alabasta Weiß',
