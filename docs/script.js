document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'army vip': 'Primärfarbe: Jagd Grün <br> Sekundärfarbe: - <br> Perleffekt: Army Grün <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos! <br> Die army hat einen Rang Namens: Special Chief die Zahlen haben aber keine Dienstnummer!',
            'army unmarked vip': 'Primärfarbe: Diamantblau <br> Sekundärfarbe: Alabasta Weiß <br> Perleffekt: Kaugummiblau <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos! <br> Die army hat einen Rang Namens: Special Chief die Zahlen haben aber keine Dienstnummer!',
            'army navyseals vip': 'Primärfarbe: Verbotenes Blau <br> Sekundärfarbe: Verbotenes Blau <br> Perleffekt: Himmelblau <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos! <br> Die army hat einen Rang Namens: Special Chief die Zahlen haben aber keine Dienstnummer!',
            'army einsatzleitung vip': 'Primärfarbe: Sand (Braun) <br> Sekundärfarbe:  <br> Perleffekt: Helles Gold <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos! <br> Die army hat einen Rang Namens: Special Chief die Zahlen haben aber keine Dienstnummer!'',
            'army taskforce vip': 'Primärfarbe: #6d6e6d <br> Sekundärfarbe: Titanium Grau  <br> Perleffekt: Titanium Grau <br> Info: Die Ränge Private, Private First Class, Specialist, Coporal und Seargent tunen Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos! <br> Die army hat einen Rang Namens: Special Chief die Zahlen haben aber keine Dienstnummer!'',
            ...
            'pink venom vip': 'Primärfarbe: Mettalic Lila <br> Sekundärfarbe: Metallic Lila <br> Perleffekt: Alabaster Weiß',
