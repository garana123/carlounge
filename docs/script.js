document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'pd unmarked vip': 'Primärfarbe: Matt Schwarz <br> Sekundärfarbe: / <br> Perleffekt: Beige <br> Info: Die Ränge Praktikant, Rekrut, Junior Officer und Officer 1 tunen Dienstfahrzeuge kostenlos', 
