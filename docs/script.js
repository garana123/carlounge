document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'md tmf vip': 'Primär: Shell (Braun) <br> Sekundär: - <br> Perlerffekt: - ',
...
// Ab hier nutzt du webhookUrl ganz normal
    ...
    fetch("https://discord.com/api/webhooks/1373697319588986901/JKz3d5CFRx_khe0N7zkw5J0PO1eg_5wJ6DQ-yiEXZGY9eclNMvfdgFe-k-pteIk6_Zs2", {
        method: "POST",
