document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'pd vip': 'Primärfarbe: Matt Schwarz <br> Sekundärfarbe: - <br> Perleffekt: Schwarz <br> Info: Die Ränge Praktikant, Rekrut, Junior Officer und Officer 1 tunen Dienstfahrzeuge kostenlos',
            ...
            'army tmf vip': 'Primärfarbe: Jagd Grün <br> Sekundärfarbe: - <br> Perleffekt: Army Grün <br> Info: Der Rang Feld-Sanitäter tuned Dienstfahrzeuge kostenlos <br> Kennzeichen für Dienstautos sind immer kostenlos!',
            ...
            'pink venom': 'Primärfarbe: Zuckerpflaume (Pink) <br> Sekundärfarbe: - <br> Perleffekt: Alabaster Weiß',
