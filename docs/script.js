document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'md tmf vip': md tmf vip': 'Primär: Shell (Braun) <br> Sekundär: - <br> Perlerffekt: Nichts (Schwarz) <br> Info: Die Ränge Praktikant, Sanitäter, Allg. Mediziner und Feld-Sanitäter tunen Dienstfahrzeuge kostenlos',
            'md tmf umarked vip': 'Primär: Hell Braun <br> Sekundär: - <br> Perlerffekt: Nichts (Schwarz) <br> Info: NUR dem Einsatzleiter/in dies bezüglich tunen!',
