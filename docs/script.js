document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'army vip': 'Primärfarbe: Jagd Grün (Weiß) <br> Sekundärfarbe: Jagd Grün <br> Perleffekt: Army Grün <br> Info: Die Ränge Cadet, Junior Deputy, Deputy, Sr.Deputy und Master Deputy tunen Dienstfahrzeuge kostenlos',
